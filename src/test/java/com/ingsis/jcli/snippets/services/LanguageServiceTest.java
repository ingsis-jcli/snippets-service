...
public class LanguageServiceTest {
  ...
  private final static String languageOk = "printscript";
  private final static String versionOk = "1.1";
  private final static LanguageVersion languageVersionOk = new LanguageVersion(languageOk, versionOk);
  private final static String url = "http://printscript:8080/";
  ...
  public void getLanguageVersionException() {
    ...
    NoSuchLanguageException exception = assertThrows(NoSuchLanguageException.class, () ->
