...
public class PermissionServiceTest {
  ...
  //    when(permissionsClient.hasPermission(PermissionType.SHARED.name, snippetId,
  // userId)).thenReturn(responseEntity);
  //
  //    assertTrue(permissionService.hasPermissionOnSnippet(PermissionType.READ, snippetId,
  // userId));
  ...
  //
  //    assertFalse(permissionService.hasPermissionOnSnippet(PermissionType.READ, snippetId,
  // userId));
  //    assertNotEquals(ownerId, userId);
  //  }
  //
